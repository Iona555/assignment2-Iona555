...
void test_validate_my_username()
{
    ...
    const char* my_name_1 = my_username();
    char* my_name_2 = malloc_username_from_conf_file();
    TEST_ASSERT_EQUAL_STRING_MESSAGE(my_name_1, my_name_2, "The username did not match!");
    free(my_name_2);
}
